...
class gamma_1yr_data(scenario):
    r"""Gamma 1-yr Data Scenario

    Separated stormwater network driven by 365 day time series.
    ...
    def __init__(self):
        ...
        self.config = yaml.load(open(load_config("gamma_1yr_data"), "r"), yaml.FullLoader)
