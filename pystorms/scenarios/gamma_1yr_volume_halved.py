...
class gamma_1yr_volume_halved(scenario):
    r"""Gamma Scenario, with one year of data and halved volumes for ponds
    ...
    def __init__(self):
        ...
        self.config = yaml.load(open(load_config("gamma_1yr_volume_halved"), "r"), yaml.FullLoader)
